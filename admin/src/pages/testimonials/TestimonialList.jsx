...
import { Plus, Pencil, Trash2, Star, MessageSquareQuote, Check, X as XIcon } from 'lucide-react'
...
export default function TestimonialList() {
  ...
  const { register, handleSubmit, reset, control, formState: { errors, isSubmitting } } = useForm({ resolver: zodResolver(testimonialSchema) })
    ...
    <div>
      ...
      >
        <form className="space-y-5">
          ...
          <FormField label="Video URL" hint="Optional"><Input {...register('videoUrl')} placeholder="https://..." /></FormField>
          <Controller
            name="isFeatured"
            control={control}
            render={({ field }) => (
