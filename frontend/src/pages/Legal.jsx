...
export function PrivacyPolicy() {
  return (
    <>
      <Seo title="Privacy Policy" description="How Summit Roof Co. collects, uses, and protects your data." path="/privacy-policy" />
      ...
      <section className="bg-white py-20 dark:bg-ink-950">
        <Container className="max-w-3xl space-y-6 text-sm leading-relaxed text-ink-600 dark:text-ink-400">
          ...
          <p>Summit Roof Co. ("we," "us") collects contact information you submit through our forms — such as your name, phone number, email, and project details — solely to respond to your inquiry and provide requested services.</p>
          ...
          <p>You may request access to, correction of, or deletion of your data at any time by contacting hello@summitroofco.com.</p>
        </Container>
      </section>
    </>
  )
...
export function Terms() {
  return (
    <>
      <Seo title="Terms of Service" description="Terms governing use of the Summit Roof Co. website." path="/terms" />
      ...
      <section className="bg-white py-20 dark:bg-ink-950">
        <Container className="max-w-3xl space-y-6 text-sm leading-relaxed text-ink-600 dark:text-ink-400">
          ...
          <p>Summit Roof Co. is not liable for indirect damages arising from use of this website. Service agreements are governed by your signed project contract.</p>
        </Container>
      </section>
    </>
  )
