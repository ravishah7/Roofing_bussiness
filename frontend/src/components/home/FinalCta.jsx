    ...
    <section className="relative overflow-hidden bg-ink-950 py-24 md:py-32">
      ...
      <Container className="relative z-10 text-center">
        ...
        >
          ...
          <Button as="a" href="tel:+18005551212" variant="outline" size="lg" icon={Phone} iconPosition="left" className="border-white/25 text-white hover:border-ember-500 hover:text-ember-400">
            (800) 555-1212
          </Button>
        </motion.div>
      </Container>
