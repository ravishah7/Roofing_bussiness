        ...
        <Container className="flex h-20 items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-ink-200 text-ink-700 transition-colors hover:border-ember-500 hover:text-ember-600 dark:border-ink-700 dark:text-ink-200 dark:hover:border-ember-400 dark:hover:text-ember-400"
            >
            ...
            <button
              className="flex h-10 w-10 items-center justify-center rounded-full border border-ink-200 text-ink-700 dark:border-ink-700 dark:text-ink-200 lg:hidden"
              onClick={() => setOpen((o) => !o)}
