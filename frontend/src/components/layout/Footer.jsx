    ...
    <footer className="bg-ink-50 text-ink-600 dark:bg-ink-950 dark:text-ink-300">
      <Container className="grid grid-cols-1 gap-12 py-16 md:grid-cols-2 lg:grid-cols-5 lg:py-20">
        <div className="lg:col-span-2">
          <Link to="/" className="flex items-center gap-2.5">
            ...
            <span className="font-display text-xl font-semibold text-ink-900 dark:text-white">Summit Roof Co.</span>
          </Link>
          <p className="mt-5 max-w-sm text-sm leading-relaxed text-ink-500 dark:text-ink-400">
            Licensed, bonded, and insured roofing contractors serving the greater metro area
            since 1999. Residential and commercial roofing built to outlast the weather.
          </p>
        ...
        <div>
          ...
          <ul className="mt-5 space-y-4 text-sm">
            <li className="flex items-start gap-3">
              ...
              <span>4820 Roofline Avenue, Suite 200<br />Chicago, IL 60601</span>
            </li>
            <li className="flex items-center gap-3">
              <Phone className="h-4 w-4 shrink-0 text-ember-500" />
              <a href="tel:+18005551212" className="hover:text-ember-600 dark:hover:text-ember-400">(800) 555-1212</a>
            </li>
            <li className="flex items-center gap-3">
              <Mail className="h-4 w-4 shrink-0 text-ember-500" />
              <a href="mailto:hello@summitroofco.com" className="hover:text-ember-600 dark:hover:text-ember-400">hello@summitroofco.com</a>
            </li>
          </ul>
          <Link
            to="/contact"
      ...
      <div className="border-t border-ink-200 dark:border-ink-900">
        <Container className="flex flex-col items-center justify-between gap-4 py-6 text-xs text-ink-500 dark:text-ink-500 md:flex-row">
          <p>© {new Date().getFullYear()} Summit Roof Co. All rights reserved. License #ROC-884213.</p>
